...
class KembaliController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $tglPeminjaman = $data->tgl_peminjaman;
        $tglPengembalian = $data->tgl_pengembalian;
        ...
        try {
            ...
            $response = $client->request('POST', $url, [
                'json' => [
                    ...
                    "data" => [
                        "message" => "*BarangQue (Pengembalian)*\n\n*Informasi Peminjam :*\nNama : " . Auth::user()->name . "\nNo. Wa : " . Auth::user()->no_wa . "\n\n*Informasi Barang :* \nJenis : " . $jenis . "\nNama Barang : " . $namaBarang . " \nNo. Barang : " . $no_barang . "\nKeperluan : " . $keperluan . "\nTgl. Peminjaman : " . $tglPeminjaman . "\nTgl. Pengembalian : " . $tglPengembalian . "\n\nBarang telah di kembalikan ketempat penyimpanan dengan aman, Silakan buka link berikut untuk melihat info lebih detail :"// message
                    ]
                ]
            ]);
