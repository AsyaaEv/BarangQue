<form wire:submit.prevent='save' class="w-full h-auto flex flex-col gap-3">
    <div class="w-full h-auto flex {{ (session('msg')) ? 'block' : 'hidden' }}">
    ...
    <div class="w-full h-auto flex gap-2 justify-end items-center text-sm">
        <div class="">Belum punya akun? <a href="" class="text-blue-500">daftar</a></div>
    </div>
