<div class="w-full h-auto justify-center items-center flex flex-col gap-4">
    <div
        ...
        <div class="w-[90%] h-auto flex flex-col md:flex-row md:gap-4">
            <div class="w-full h-auto flex justify-center items-center">
                <img src="{{ Storage::url('src/assets/vWelcome.svg') }}" alt="" class="w-[15rem] h-[15rem] md:w-[30rem] md:h-[30rem]" >
            </div>
    ...
    <div
        ...
        <div class="w-[90%] h-auto flex flex-col gap-2 md:flex-row">
            <div class="w-full h-auto flex justify-center items-center">
                <img src="{{ Storage::url('src/assets/vForm.svg') }}" alt="" class="w-[15rem] h-[15rem] md:w-[30rem] md:h-[30rem]">
            </div>
    ...
    <div
        ...
        <div class="w-[90%] h-auto flex flex-col gap-2">
            <div class="w-full h-auto flex justify-center items-center">
                <img src="{{ !$this->foto ? Storage::url('src/assets/vPicture.svg') : $this->foto->temporaryUrl() }}" alt="" class="w-[15rem] h-[15rem] rounded-full border-2 border-black shadow-sm">
            </div>
            <div class="w-full h-auto flex flex-col justify-center items-center">
                <div class="font-bold text-3xl text-primary">Barang<span class="text-sec">Que</span></div>
                <div class="text-md">Silakan masukan data anda untuk mendaftar</div>
    ...
    <div
        ...
        <div class="w-[90%] h-auto flex flex-col gap-2">
            <div class="w-full h-auto flex justify-center items-center">
                <img src="{{ Storage::url('src/assets/vOtp.svg') }}" alt="" class="w-[15rem] h-[15rem]">
            </div>
            <div class="w-full h-auto flex flex-col justify-center items-center">
                <div class="font-bold text-3xl text-primary">Barang<span class="text-sec">Que</span></div>
                <div class="text-md">Silakan masukan data anda untuk mendaftar</div>
