<div class=" p-4">
    <div
        ...
        <i class="ph ph-trash p-2 rounded-full bg-primary text-white mr-2"></i>
        Hapus Foto Profile
    </div>
    <div class="w-full h-auto">
        <div class="">Apakah anda yakin untuk menghapus foto profile?</div>
    </div>
    <div class="w-full h-auto flex gap-[10px] justify-end items-center">
        <div class="flex flex-wrap items-center justify-end p-4 shrink-0 text-blue-gray-500">
            ...
            <button data-ripple-light="true" data-dialog-close="true" type="submit" wire:click='removePP'
