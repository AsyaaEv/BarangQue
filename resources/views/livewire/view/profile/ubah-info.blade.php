<div>
    <div
        class="flex items-center p-4 font-sans text-2xl antialiased font-semibold leading-snug shrink-0 text-primary border-b-2">
        <i class="ph ph-user p-2 rounded-full bg-primary text-white mr-2"></i>
        Ubah Informasi Pengguna
    </div>
    <form wire:submit.prevent='ubahInfo'>
        <div class="w-full h-auto flex flex-col gap-[10px] px-4 mt-4">
            <div class="">
