<section class="w-full h-auto flex justify-center items-center flex-col mt-8 gap-[25px]">
    ...
    @if (session('testimoni'))
        <div class="w-full h-auto p-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center px-8 {{ $this->toggleTesti == false ? 'hidden' : 'block' }}"
            id="popupTesti">
