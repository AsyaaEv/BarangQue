<div class="">
    <div data-dialog-backdrop="dialogKameraKembali" data-dialog-backdrop-close="true"
        ...
        <div data-dialog="dialogKameraKembali"
...
<script>
    ...
    const buttonKembali = document.getElementById('buttonKembali')
    let id
    let imageData
    ...
    function ambilGambar() {
        ...
        buttonKembali.classList.remove('invisible');
