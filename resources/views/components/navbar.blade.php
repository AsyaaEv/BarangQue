...
<div class="w-full h-screen -translate-x-[50rem] transition-all duration-200 py-[2rem] bg-white absolute z-50" id="nav">
    <div class="w-full h-auto flex px-[1rem] gap-[10px] justify-center items-center">
        ...
        <div class="w-full h-full flex justify-center flex-col">
            <div class="text-xl font-semibold">Anggun rasya evaldo</div>
            <div class="">Selamat datang di dashboard barangque👋</div>
        </div>
    </div>
    <div class="w-full h-full flex  flex-col gap-3">
        <div class="w-full h-auto mt-[2rem] px-[2rem] ">
            ...
            <div class="w-full h-auto flex flex-col gap-[10px] mt-4 justify-center items-center">
                <a href="/dashboard" class="w-[90%] h-[3rem] @if (request()->is('dashboard')) bg-[#F6F8FA] shadow @else bg-transparent @endif  rounded-[10px]  flex justify-between items-center px-4">
                    <div class="w-auto h-auto flex gap-[10px] justify-center items-center">
                        <i class="ph ph-table text-2xl @if (request()->is('dashboard')) text-blue-600 @else  @endif"></i>
                        <div class="@if (request()->is('dashboard')) font-semibold text-blue-600 @else  @endif">Dashboard</div>
                    </div>
                    <i class="ph ph-caret-right @if (request()->is('dashboard')) block @else invisible @endif"></i>
                </a>
                
                <a href="/dashboard/barang" class="w-[90%] h-[3rem] @if (request()->is('dashboard/barang')) bg-[#F6F8FA] shadow @else bg-transparent @endif  rounded-[10px]  flex justify-between items-center px-4">
                    <div class="w-auto h-auto flex gap-[10px] justify-center items-center">
                        <i class="ph ph-stack text-2xl @if (request()->is('dashboard/barang')) text-blue-600 @else  @endif"></i>
                        <div class="@if (request()->is('dashboard/barang')) font-semibold text-blue-600 @else  @endif">Barang</div>
                    </div>
