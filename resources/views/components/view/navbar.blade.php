    ...
    <div class="w-full h-full flex  flex-col gap-3">
        <div class="w-full h-auto mt-[2rem] px-[2rem] ">
            ...
            <div class="w-full h-auto flex flex-col gap-[10px] mt-4 justify-center items-center">
                <a href="/"
                    class="w-[90%] h-[3rem] @if (request()->is('/')) bg-[#F6F8FA] shadow @else bg-transparent @endif  rounded-[10px]  flex justify-between items-center px-4">
                    <div class="w-auto h-auto flex gap-[10px] justify-center items-center">
                        <i
                            class="ph ph-table text-2xl @if (request()->is('/')) text-blue-600 @else @endif"></i>
                        <div class="@if (request()->is('/')) font-semibold text-blue-600 @else @endif">
                            Home</div>
                    </div>
                    <i class="ph ph-caret-right @if (request()->is('/')) block @else invisible @endif"></i>
                </a>
            </div>
        </div>
